...
let roomSizesButtons = document.querySelectorAll(
  ".target-1 .transparent-button"
);
let siteSizesButtons = document.querySelectorAll(
  ".target-2 .transparent-button"
);
let jurSizesButtons = document.querySelectorAll(
  ".target-3 .transparent-button"
);

let roomPriceBlock = document.querySelector(
  '[data-client-type="room-people-price"] .workload-content'
);
let sitePriceBlock = document.querySelector(
  '[data-client-type="site-people-price"] .workload-content'
);
let jurPriceBlock = document.querySelector(
  '[data-client-type="jur-people-price"] .workload-content'
);
...
async function renderJson(animActive) {
  const allServicesPrices = await (
    await fetch("/wp-content/themes/ecodez/services-list.json")
  ).json();
...
function getCategoryTemplate(block, e) {
  block.insertAdjacentHTML(
    ...
    `
            ...
            <p>от <span class="workload-price-accent">${
              e[activePriceButton || "price_1"]
            } BYN</span></p>
            </div>
        `
  );
  ...
  e.addEventListener("click", () => {
    ...
    anime({
      targets: document.querySelector(
        `.${parentBlockClassName[1]} .workload-content`
      ).children,
      opacity: [1, 0.7],
      scale: [1, 0.8],
    });
...
if (reviewsBlock != null) {
  ...
  let reviewsDots = document.querySelectorAll(
    ".reviews-dots .reviews-prev-dots"
  );
  ...
  function changeSlide(e) {
    ...
    reviewsDots[activeSliderIndex].classList.add("active");
    reviewsBlock.style.transform = `translateX(-${
      activeSliderIndex * reviewsBlockItem[0].clientWidth
    }px)`;
    setTimeout(() => {
      scrollingOver = true;
    }, 500);
...
let calculateInput = document.querySelector(
  ".calculate-form .input-calculate input"
);
let calculateResult = document.querySelector(
  ".calculate-form .input-calculate .itogo"
);
let selectFizOrJur = document.querySelectorAll(
  ".calculate-form .fiz-or-jur input"
);
let fizCalculateBlock = document.querySelector(
  ".calculate-form .fiz-calculate"
);
let jurCalculateBlock = document.querySelector(
  ".calculate-form .jur-calculate select"
);
let selectFizSize = document.querySelectorAll(
  ".calculate-form .fiz-calculate input"
);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelector(".preolader svg path").style.transform =
    "rotate(45deg)";
  setTimeout(() => {
  ...
  let ctaSmallButton = document.querySelector(
    ".cta-small-block .cta-button.transparent-button"
  );
  ...
  function changePositionCtaButton() {
    ...
    positionCtaButton =
      ctaSmallCircle.getBoundingClientRect().width / 2 +
      ctaSmallButton.offsetWidth / 2;
  ...
  const callback = function (mutationsList) {
    for (let mutation of mutationsList) {
      if (
        ...
        targetbodyObserver.classList.contains("loaded")
      ) {
          ...
          if (e) {
            ...
            new Waypoint({
              element: document.querySelector(
                ".price-section .target-1 .workload-content"
              ),
        ...
        function main() {
          ...
          sources.forEach(function (sourceNode) {
            ...
            sourceNode.addEventListener("click", function () {
              ...
              setTimeout(
                () =>
                  (activeAnimWorkloadItem = document.querySelector(
                    `.target-${sourceNodeId} .workload-content`
                  )),
                600
              );
              anime({
              ...
              setTimeout(() => {
                activeAnimPriceWorkload = document.querySelector(
                  `.target-${sourceNodeId} .price-workload`
                );
                simpleAnimItem(activeAnimPriceWorkload);
                activeAnimWorkloadButtons = document.querySelector(
                  `.target-${sourceNodeId} .workload-buttons`
                );
        ...
        let activeAnimAboutSection =
          document.querySelectorAll(".about-section");
        activeAnimAboutSection.forEach((e) => {
          simpleAnimItem(e);
        });

        let activeAnimReviewsSection =
          document.querySelectorAll(".reviews-section");
        activeAnimReviewsSection.forEach((e) => {
          simpleAnimItem(e);
        });

        let activeFirstLineAnimServicesSection = document.querySelector(
          ".services-section .flex-list"
        );
        flexRowAnimItem(activeFirstLineAnimServicesSection);

        let activeAnimPriceButtons = document.querySelector(
          ".price-section .price-buttons"
        );
        flexRowAnimItem(activeAnimPriceButtons);

        let activeAnimPriceSection = document.querySelector(
          ".whyus-section .flex-list"
        );
        flexRowAnimItem(activeAnimPriceSection);

        let activeAnimAboutWorkingSection = document.querySelector(
          ".about-working-section .flex-list"
        );
        flexRowAnimItem(activeAnimAboutWorkingSection);

        let activeAnimServicesPageAboutSectionTitle = document.querySelectorAll(
          ".about-section .services-page-title"
        );
        activeAnimServicesPageAboutSectionTitle.forEach((e) => {
          simpleAnimItem(e);
        });

        let activeAnimServicesPageTitleW100 = document.querySelectorAll(
          ".service-info-w-100 .services-page-title"
        );
        ...
        let activeAnimServiceInfoImage = document.querySelectorAll(
          ".service-info .services-page-image"
        );
        activeAnimServiceInfoImage.forEach((e) => {
          simpleAnimItem(e);
        });

        let activeAnimUsefulMaterial = document.querySelectorAll(
          ".service-info .useful-material"
        );
        activeAnimUsefulMaterial.forEach((e) => {
          animFromDownToUp(e);
        });

        let activeAnimServicesPageTitle = document.querySelectorAll(
          ".service-info .service-text .services-page-title"
        );
        activeAnimServicesPageTitle.forEach((e) => {
          animFromDownToUp(e);
        });

        let activeAnimServicesPageText =
          document.querySelectorAll(".service-info p");
        activeAnimServicesPageText.forEach((e) => {
          animFromDownToUp(e);
        });

        let activeAnimServicesPageTextList =
          document.querySelectorAll(".service-info ul");
        activeAnimServicesPageTextList.forEach((e) => {
          animFromDownToUp(e);
        });

        let activeAnimServicesSeporatorInfo = document.querySelectorAll(
          ".service-info .services-seporator-info"
        );
        activeAnimServicesSeporatorInfo.forEach((e) => {
          animFromDownToUp(e);
        });

        let activeAnimCustomServiceList = document.querySelector(
          ".service-info .custom-service-list"
        );
        ...
        let activeAnimCtaFirstBlock = document.querySelectorAll(
          ".bottom-form .cta-first-block"
        );
        activeAnimCtaFirstBlock.forEach((e) => {
          simpleAnimItem(e);
        });

        let activeAnimContactSectionH4 = document.querySelectorAll(
        ...
        let activeAnimContactSectionItem = document.querySelectorAll(
          ".contact-us-section .contacts-item"
        );
        activeAnimContactSectionItem.forEach((e) => {
          animFromDownToUp(e);
        });

        let activeAnimCtaBlockImage = document.querySelectorAll(
          ".bottom-form .services-page-image"
        );
        activeAnimCtaBlockImage.forEach((e) => {
          simpleAnimItem(e);
        });

        let activeAnimCtaBlockForm = document.querySelectorAll(
          ".bottom-form .wpcf7-form .cta-form-input"
        );
        activeAnimCtaBlockForm.forEach((e) => {
          animFromDownToUp(e);
        });

        let activeAnimContactsForm = document.querySelectorAll(
          ".contacts-form.bottom-form .wpcf7 p"
        );
        activeAnimContactsForm.forEach((e) => {
          animFromDownToUp(e);
        });

        let activeAnimServiceInfoW100 = document.querySelectorAll(
          ".service-info-w-100 .flex-list"
        );
        activeAnimServiceInfoW100.forEach((e) => {
          flexRowAnimItem(e);
        });

        let activeAnimWorkloadButtons = document.querySelector(
          ".price-section .target-1 .workload-buttons"
        );
        flexRowAnimItem(activeAnimWorkloadButtons);

        let activeAnimPriceWorkload = document.querySelector(
          ".price-section .target-1 .price-workload"
        );
        simpleAnimItem(activeAnimPriceWorkload);

        let activeAnimWorkloadItem = document.querySelector(
          ".price-section .workload-content"
        );
        workloadContentAnim(activeAnimWorkloadItem);

        let activeAnimFaqSection = document.querySelector(
          ".faq-section .flex-list"
        );
  ...
  let allServiceInfoBlock = document.querySelectorAll(
    ".service-info .flex-list"
  );

  function resizeServiceInfoImg() {
    allServiceInfoBlock.forEach((e) => {
      e.querySelector(".services-page-image").style.height = `${
        e.querySelector(".service-text").offsetHeight
      }px`;
    });
  }
